...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://webservice.ttech.com/", "divideResponse");
    private final static QName _SubtractResponse_QNAME = new QName("http://webservice.ttech.com/", "subtractResponse");
    private final static QName _Add_QNAME = new QName("http://webservice.ttech.com/", "add");
    private final static QName _Multiply_QNAME = new QName("http://webservice.ttech.com/", "multiply");
    private final static QName _Divide_QNAME = new QName("http://webservice.ttech.com/", "divide");
    private final static QName _MultiplyResponse_QNAME = new QName("http://webservice.ttech.com/", "multiplyResponse");
    private final static QName _AddResponse_QNAME = new QName("http://webservice.ttech.com/", "addResponse");
    private final static QName _Subtract_QNAME = new QName("http://webservice.ttech.com/", "subtract");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.ttech.com/", name = "subtract")
